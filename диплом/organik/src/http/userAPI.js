...
export const registration = async (login, password, email, phone_number) => {
    try {
        const response = await guestInstance.post('user/registration', {login, password, email, phone_number, role: 'USER'})
